...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/dashboard', function () {
        ...
        return view('dashboard.dashboard_login'); // Fallback
    ...
    Route::patch('/profile/update', [App\Http\Controllers\ProfileController::class, 'update'])->name('profile.update.breeze');
    Route::delete('/profile/breeze', [ProfileController::class, 'destroy'])->name('profile.destroy.breeze');

    // Update password untuk pengguna yang terotentikasi
