...
<div class="max-w-4xl mx-auto">
    ...
    <div class="space-y-6">
        ...
        <div class="border-b border-gray-200 pb-3">
            ...
            <p class="text-gray-800 text-lg mt-1">{{ $item['lost_id'] }}</p>
        </div>

        <!-- Found ID -->
        <div class="border-b border-gray-200 pb-3">
            <label class="text-red-500 font-medium text-sm">* Found ID</label>
            <p class="text-gray-800 text-lg mt-1">{{ $item['found_id'] }}</p>
        </div>
        ...
        <!-- Lost Date -->
        <div class="border-b border-gray-200 pb-3">
            <label class="text-red-500 font-medium text-sm">* Lost Date</label>
            <p class="text-gray-800 text-lg mt-1">{{ $item['lost_date'] }}</p>
        </div>

        <!-- Found Date -->
        <div class="border-b border-gray-200 pb-3">
            <label class="text-red-500 font-medium text-sm">* Found Date</label>
            <p class="text-gray-800 text-lg mt-1">{{ $item['found_date'] }}</p>
        </div>
