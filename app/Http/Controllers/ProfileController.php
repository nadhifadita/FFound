...
class ProfileController extends Controller
{
    ...
    public function update(ProfileUpdateRequest $request): RedirectResponse
    {
        ...
        // Redirect ke halaman tampilan profil berdasarkan role
        $redirectRouteName = auth()->user()->role === 'petugas' ? 'profile_petugas' : 'profile';
        return Redirect::route($redirectRouteName)->with('status', 'profile-updated');
    }
